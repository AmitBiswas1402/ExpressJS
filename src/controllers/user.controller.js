...
const loginUser = asyncHandler(async (req, res) => {
    ...
    if (!user) {
        throw new ApiError(404, "User doeesn't exist")
    }
    ...
    const loggedInUser = await User.findId(user._id).select("-password -refreshToken")
...
const refreshAccessToken = asyncHandler(async(req, res) => {
    ...
    try {
        ...
        if (user) {
            throw new ApiError(401, "Something went wrong while generating refreshing and access tokens")
        }
